...
use Illum\Validation\ValidationData;
use Illum\Validation\ValidationException;
...
class ValidationValidatorTest extends TestCase
{
    ...
    public function testCustomExceptionMustExtendValidationException()
    {
        ...
        $this->expectExceptionMessage('Exception [RuntimeException] is invalid. It must extend [Illum\Validation\ValidationException].');
...
1',
    ...
    public function testDateEquals()
    {
        ...
        $v = new Validator($trans, ['x' => new Chronos('2000-01-01')], ['x' => 'date_equals:2000-01-01']);
        $this->assertTrue($v->passes());

        $v = new Validator($trans, ['x' => new Chronos('2000-01-01')], ['x' => 'date_equals:2001-01-01']);
        $this->assertTrue($v->fails());
    ...
    public function testBeforeAndAfter()
    {
        ...
        $v = new Validator($trans, ['x' => new Chronos('2000-01-01')], ['x' => 'Before:2012-01-01']);
        $this->assertTrue($v->passes());
        ...
        $v = new Validator($trans, ['x' => new Chronos('2012-01-01')], ['x' => 'After:2000-01-01']);
        $this->assertTrue($v->passes());
        ...
        $v = new Validator($trans, ['start' => new DateTime('2012-01-01'), 'ends' => new Chronos('2013-01-01')], ['start' => 'Before:ends', 'ends' => 'After:start']);
        $this->assertTrue($v->passes());
